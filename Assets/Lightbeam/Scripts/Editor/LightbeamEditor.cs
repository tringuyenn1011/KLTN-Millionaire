...
public class LightbeamEditor : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        if (lightBeam.IsModifyingMesh)
        {
            ...
            lightBeam.RadiusTop = Handles.ScaleValueHandle(
    lightBeam.RadiusTop, 
    rTopPos, 
    Quaternion.identity, 
    rTopSize, 
    Handles.CylinderHandleCap,  // sửa ở đây
    2
);

lightBeam.RadiusBottom = Handles.ScaleValueHandle(
    lightBeam.RadiusBottom, 
    rBottomPos, 
    Quaternion.identity, 
    rBottomSize, 
    Handles.CylinderHandleCap,  // sửa ở đây
...
lightBeam.Length = Handles.ScaleValueHandle(
    lightBeam.Length, 
    lengthPos, 
    Quaternion.Euler(Vector3.up), 
    lengthSize, 
    Handles.CubeHandleCap,       // sửa ở đây
    0
);
